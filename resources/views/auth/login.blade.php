            ...
            <div class="card-body">
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            <input id="email" type="email" class="c_border form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            <input id="password" type="password" class="c_border form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
                    ...
                    <div class="form-group">
                        <div class="d-flex flex-column align-items-center flex-md-row">
                            ...
                            <button type="submit" class="btn color_button mt-3 mt-md-0 ml-md-4">
                                {{ __('Login') }}
                            </button>
                        </div>
                    </div>
